...
if __name__ == '__main__':
    ...
    models_list = ['convnext_base.fb_in22k_ft_in1k']
    ...
    if model_name in standard:
        features = encoding(model_name, "Standard", "V1", stimuli_path, fmri_dataset, save_folder, num_subjects)
        encoding(model_name, "Standard", "V2", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
        encoding(model_name, "Standard", "V4", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
        encoding(model_name, "Standard", "IT", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
    elif model_name in timm:
        features = encoding(model_name, "Timm", "V1", stimuli_path, fmri_dataset, save_folder, num_subjects)
        encoding(model_name, "Timm", "V2", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
        encoding(model_name, "Timm", "V4", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
        encoding(model_name, "Timm", "IT", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
    elif model_name in cornet:
        features = encoding(model_name, "Cornet", "V1", stimuli_path, fmri_dataset, save_folder, num_subjects)
        encoding(model_name, "Cornet", "V2", stimuli_path, fmri_dataset, save_folder, num_subjects, features)
