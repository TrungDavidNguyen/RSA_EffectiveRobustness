            ...
            for hemisphere in ["lh", "rh"]:
                ...
                if fmri is None:
                    ...
                    try:
                        ...
                        pass
        os.makedirs(f'fmri_data/fmri/{roi_name}/{roi_name}_fmri_subj{subjects}', exist_ok=True)
        np.save(f'fmri_data/fmri/{roi_name}/{roi_name}_fmri_subj{subjects}/{roi_name}_both_fmri_subj{subjects}.npy', fmri)
        ...
        for roi in rois:
            ...
            if fmri is None:
                ...
                try:
                    ...
                    pass
        os.makedirs(os.path.join("fmri_data/fmri_things", roi_name, f"{roi_name}_fmri_subj{subjects}"), exist_ok=True)
        np.save(os.path.join("fmri_data/fmri_things", roi_name, f"{roi_name}_fmri_subj{subjects}", f"{roi_name}_both_subj{subjects}.npy"), fmri)
